...
private fun PlantDetailDescription(plant: Plant) {
    Surface {
        Column(
            ...
            PlantWatering(wateringInternval = plant.wateringInterval)
...
private fun PlantDetailDescriptionPreview() {
    MdcTheme {
        val fakePlant = Plant("id", "Avocado", "HTML<br><br>description", 1)
...
@Composable
fun PlantWatering(wateringInternval: Int) {
    Column(
        ...
        val quantityString = resources.getQuantityString(
            ...
            wateringInternval, wateringInternval
        )
